...
map.getView().fit([671085.627835, 5919624.032503, 677469.992368, 5922948.435336], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Atractivos turísticos del Concepción Metropolitano</h2>';
        return titleElement;
    })(),
